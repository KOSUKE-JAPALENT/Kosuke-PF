const translations = {
  ja: {
    ...
    learnMore: "詳しく見る ↗",
    linkwayDesc: "LinkedInを活用し、日本にいながら海外案件・外貨獲得を目指すコミュニティ。プロフィール、発信、案件獲得を支援します。",
    ...
    mediaXTitle: "海外リモートワーク25選",
    mediaXDesc: "初心者から経験者まで、海外の仕事を探せるサービスを難易度順にまとめています。",
    mediaLinkedinTitle: "LinkWayを作った理由",
    mediaLinkedinDesc: "なぜコミュニティをつくったのか。そこに込めた想いと現在地を発信しています。",
    visionEyebrow: "THE NEXT 3 YEARS",
    ...
    faqCatWork: "仕事・働き方",
    faqCatEntertainment: "エンタメ・趣味",
    faqCatSocial: "人間関係・その他",
  ...
  en: {
    ...
    linkwayDesc: "A community helping people in Japan use LinkedIn to build global careers and earn foreign income through stronger profiles, content, and outreach.",
    ...
    mediaXTitle: "25 platforms for global remote work",
    mediaXDesc: "A difficulty-ranked collection of platforms for everyone from first-time beginners to experienced professionals.",
    mediaLinkedinTitle: "Why I built LinkWay",
    mediaLinkedinDesc: "The ideas, people, and mission behind the communities we are building.",
    visionEyebrow: "THE NEXT 3 YEARS",
    ...
    faqCatEntertainment: "Entertainment & Hobbies",
    faqCatSocial: "Relationships & More",
    contactEyebrow: "LET'S BUILD TOGETHER",
...
const faqData = {
  ...
  en: [
    ...
    },
    {
      category: "faqCatPersonality",
      items: [
        { q: "Describe yourself in three characters.", a: "AHO. Idiot." },
        { q: "How do friends describe your personality?", a: "Cheerful, loud, weird, and easy to get scolded." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: "When does motivation go up?", a: "When a new goal is set." },
    ...
    },
    {
      category: "faqCatSocial",
      items: [
        { q: "Good or bad at talking to new people?", a: "Good. Everyone, let's talk." },
        { q: "Fast or slow to reply on LINE?", a: "Fast, for people I like." },
        { q: "Team work or solo work?", a: "I'd rather work alone, but I can't get by without a team." },
        { q: "What do you want from teammates?", a: "Love." },
        { q: "If you had a week with nothing to do?", a: "Work." },
        { q: "If you won a billion-yen lottery?", a: "A round-the-world trip." },
        { q: "Gap between your online self and real self?", a: "Huge. People always tell me I'm quieter in person than they expected." }
      ]
    }
  ]
};
...
const languageParts = toggle.querySelectorAll("span");
...
function setLanguage(language) {
  ...
  languageParts[0].classList.toggle("language-active", language === "ja");
  languageParts[2].classList.toggle("language-active", language === "en");
...
const sections = ["story", "remote", "work", "impact", "news", "media", "vision", "faq"].map((id) => document.getElementById(id));
